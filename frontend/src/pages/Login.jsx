      ...
      <div className="w-full max-w-[440px] relative z-10">
        <div className="glass-panel rounded-2xl p-10 flex flex-col gap-8 shadow-2xl relative">
          ...
          <header className="flex flex-col items-center gap-3 text-center">
            ...
            <p className="text-on-surface-variant text-sm font-medium tracking-wide opacity-90">Enter your credentials to access your account.</p>
          </header>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5 group">
              <div className="flex justify-between items-center ml-1">
                <label className="text-sm font-semibold text-on-surface-variant transition-colors group-focus-within:text-primary">Password</label>
                <Link to="/forgot-password" className="text-xs font-semibold text-primary hover:text-primary-container transition-colors">Forgot password?</Link>
              </div>
